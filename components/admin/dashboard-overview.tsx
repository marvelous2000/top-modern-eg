...
export function DashboardOverview() {
  ...
  const databaseNotSetup = publishedProducts === 0 && publishedProjects === 0 && !loading
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-700">
                <p>
                  The database tables haven't been created yet. Please go to the{" "}
                  <a href="/admin?page=setup" className="font-medium underline text-yellow-700 hover:text-yellow-600">
                    Database Setup
                  </a>{" "}
                  page to initialize your database.
                </p>
              </div>
            </div>
          </div>
