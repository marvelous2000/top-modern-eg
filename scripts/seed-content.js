...
const productSeeds = [
  {
    ...
    specifications: {
      ...
      "Featured Projects": "Four Seasons Hotel Cairo, Luxury Residential Tower - New Capital, Premium Restaurant Chain - Alexandria",
    },
    status: "active",
  },
  {
    ...
    category: "marble",
    description:
      "Sophisticated black marble with striking white veining, ideal for dramatic accent walls and luxury surfaces.",
    ...
    images: [
      ...
      "/luxury-hotel-lobby-marble-installation-four-season.jpg",
    ...
    specifications: {
      ...
      "Featured Projects": "Luxury Boutique Hotel - Zamalek, High-end Restaurant - Maadi, Executive Office Building - Downtown",
    },
    status: "active",
  },
  {
    ...
    category: "granite",
    description:
      "Stunning black granite with golden speckles, prized for countertops, flooring, and statement surfaces in luxury spaces.",
    origin: "Andhra Pradesh, India",
    finish: "Polished",
    thickness: "20mm, 30mm",
    applications: ["Countertops", "Flooring", "Wall Cladding", "Reception Desks"],
    images: [
      "/black-galaxy-granite-golden-speckles-luxury.jpg",
      "/premium-absolute-black-granite-with-mirror-finish.jpg",
    ...
    specifications: {
      ...
      "Featured Projects": "Prestige Office Tower - New Cairo, Luxury Villa Collection - Palm Hills",
    },
    status: "active",
  },
]
...
const projectSeeds = [
  {
    ...
    solution:
      "Premium Italian Carrara marble for the main lobby flooring, complemented by dramatic Nero Marquina marble feature walls. Custom fabrication ensured perfect fit and finish throughout the 500-room property.",
    results: [
  ...
  },
  {
    ...
    solution:
      "Implemented a phased installation approach with dedicated quality control teams. Used premium Kashmir White granite for durability in high-traffic areas and Emperador Dark marble for luxury accent walls.",
    results: [
    ...
    images: [
      "/luxurious-calacatta-gold-marble-with-golden-veinin.jpg",
      "/kashmir-white-granite-with-subtle-grey-and-black-s.jpg",
      "/luxury-marble-workshop-with-craftsmen-working-on-p.jpg",
    ],
    testimonial: {
      quote:
  ...
  },
  {
    ...
    description:
      "Boutique hospitality renovation featuring Nero Marquina accent walls, Calacatta Gold reception counters, and bespoke stonework throughout suites and penthouses.",
    challenge:
      "Delivering handcrafted stone elements in a live hotel environment with minimal disruption to guests and operations.",
    solution:
      "Night-shift installation schedules, modular prefabricated stone panels, and on-site finishing teams ensured rapid delivery without compromising quality.",
    results: [
      "Completed 30 luxury suites in 10 weeks",
      "98% guest satisfaction post-renovation",
      "Awarded Best Luxury Boutique Hotel Renovation 2024",
    ],
    ...
    testimonial: {
      quote: "Top Modern's team delivered a flawless transformation while keeping our hotel fully operational.",
      author: "Layla Mostafa",
      position: "General Manager, Signature Hospitality Group",
    },
    status: "active",
    featured: false,
  },
