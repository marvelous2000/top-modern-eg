          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              <StaggerContainer className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {Object.keys(t.raw("sampleProjects")).map((projectKey, index) => {
                      ...
                      <Card className="group overflow-hidden border-border bg-card transition-shadow">
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="mt-4 border-t border-border pt-4">
                            <p className="text-xs font-medium text-muted-foreground">{t("sampleProjects.modernKitchen.material")}</p>
                ...
                <div className="mx-auto max-w-2xl text-center">
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button asChild size="lg" variant="secondary" className="mt-8 w-full sm:w-auto">
                      <Link href={`/${t('locale')}/contact`}>{t("cta.getStarted")}</Link>
                    </Button>
                  </motion.div>
                </div>
              </div>
